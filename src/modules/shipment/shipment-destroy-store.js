  ...
  actions: {
    async doDestroy({ commit, dispatch, rootGetters }, id) {
      try {
        ...
        await ShipmentService.destroyAll([id]);

        commit('DESTROY_SUCCESS');

        Message.success(i18n('entities.shipment.destroy.success'));
    ...
    async doDestroyAll(
      ...
      try {
        ...
        await ShipmentService.destroyAll(ids);
        ...
        Message.success(
          i18n('entities.shipment.destroyAll.success'),
        );
